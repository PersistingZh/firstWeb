package com.pqkj.common.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    NOT_VERIFICATION_CODE(401008, "请先获取最新验证码"),
    NO_VERIFICATION_CODE(401009, "请输入验证码"),
    NOT_CHECK_VERIFICATION_CODE(401010, "验证码错误"),
    PARAMETER_EXISTS(401011, "参数名称已存在"),
    /**
     * 4040...  APP报错码
     */
    NOT_CHECK_MAC_CODE(404040, "MAC验证失效"),
    NOT_PHOTO(404041, "图片不存在"),
    CLOCK_DELAY(404042, "迟到打卡"),
    ;
