...
<script type="text/html" id="toolbar">
    <div class="layui-btn-container">
        ...
        <button class="layui-btn layui-btn-sm" lay-event="batchDeleted" shiro:hasPermission="${entity?uncap_first}:delete">删除</button>
    </div>
</script>
<script type="text/html" id="tool">
    <a class="layui-btn layui-btn-xs" lay-event="edit" shiro:hasPermission="${entity?uncap_first}:update">编辑</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" shiro:hasPermission="${entity?uncap_first}:delete">删除</a>
</script>
